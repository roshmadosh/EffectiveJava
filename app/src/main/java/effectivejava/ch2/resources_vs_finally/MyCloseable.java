 ...
 *
 *	An exception thrown from a finally block can overshadow one that's thrown from within the try-block. This can be problematic if the cause of 
 *	this outer exception was a result of the inner exception being thrown, and the underlying cause won't be diagnosable. 
 */
